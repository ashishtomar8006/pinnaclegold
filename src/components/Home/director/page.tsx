      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="relative">
            {/* Image card */}
            <div className="relative rounded-3xl overflow-hidden shadow-2xl bg-slate-900/10">
              <div className="relative h-140 sm:h-140 w-full">
                <Image
                  src="/images/users/director-img.png"
